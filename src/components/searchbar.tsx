  ...
  return (
    <div className="fixed left-1/2 top-0 z-9999 -translate-x-1/2">
      ...
      <div
        ...
        onMouseEnter={show}
        className={cn(
          "flex items-center gap-2 rounded-full border border-white/10 bg-[#222] p-2 shadow-lg backdrop-blur-sm transition-transform duration-300 ease-in-out",
      ...
      <div
        onMouseEnter={show}
        className={cn(
          "absolute left-1/2 top-0 h-3 w-16 -translate-x-1/2 rounded-b-full border border-white/10 border-t-0 bg-[#222] shadow-md shadow-black/30 transition-opacity",
