  ...
  return (
    <div className="fixed bottom-0 right-4 z-9999">
      <div
        ...
        className={cn(
          "absolute bottom-0 left-1/2 h-3 w-16 -translate-x-1/2 rounded-t-full border border-white/10 border-b-0 bg-[#222] shadow-md shadow-black/30 transition-opacity",
      ...
      <div
        ...
        onMouseMove={show}
        className={cn(
          "rounded-lg border border-white/10 bg-[#111] p-2 transition-transform duration-300 ease-in-out",
